...
<div class="container">
    <div class="lg:flex gap-x-4">
        ...
        <?php if(have_posts()):
                ...
                <div class="mb-2 text-gray-500 text-sm"><i class="icon-calendar"></i> <?= get_the_date()?></div>
                <?php if(! empty( $post_views_count )){ ?>
                    <div class="mb-3 text-gray-500 text-sm"><i class="icon-eye"></i> Перегляди: <?= $post_views_count;?></div>
                <?php } ?>
                <?php if($logo){?>
